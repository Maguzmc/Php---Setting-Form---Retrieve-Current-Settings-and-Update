...
<html>
<!-- Document Name: SettingFormPage_Sub2.php -->	
<head>
...
// 4.4 Apply logic test to each Setting variable to determine the value that will be loaded back into the table
    ...
    if ($bed_knob == "Same") {$bed_knob = $Obed_knob;};
...
$sql = "UPDATE SettingTable SET bed_door ='" . $bed_door . "', cht_temp='" . $cht_temp . "',bed_knob='" . $bed_knob . "' where id='1';"; 
...
<body>
  ...
  <div class="mytextSub">&nbspIf u want to return to Settings page please (Click) "Submit":</div>
	<br>
	<br>
  <form method="POST" action="SettingFormPage_Input2.php">
